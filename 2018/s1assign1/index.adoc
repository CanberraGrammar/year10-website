...
This assignment was last updated on *Tuesday 6 March 2018*.

* *6 March:* Added the CGS Campus map in the <<_school_branding, School Branding>> section.

* *15 February:* Added the <<_school_branding, School Branding>> section with material to help design the app consistent with the CGS branding and colour schemes.
...
* link:cgs_campus_map.pdf[CGS Campus Map]
