...
:page-title: Year 10 IST - Course Overview

= Year 10 IST

Year 10 iPhone and iPad Application Development is a one year course that forms part of the Information Technology program at Canberra Grammar School. The course is based upon, and complies with, the Information and Software Technology (IST) syllabus provided by the NSW Board of Studies.

The course requires students to have completed Year 9 IST (Web Design and Application Development) at Canberra Grammar School or have an equivalent level of programming knowledge.
...
There's a major final project in Semester Two. You can work individually or in a group. There's also an epic overnight hackathon, with pizza and soft drinks!
...
^.^| *Term 1*
10+^.^|
*Topic 1: Introduction to Swift and iOS development* +
[outcomes]##Outcomes: 5.1.1, 5.2.1, 5.2.2, 5.5.1##

{set:cellbgcolor:white}
^.^| *Term 2*
4+^.^|
*Topic 2: Git version control* +
[outcomes]##Outcomes: 5.1.1, 5.1.2, 5.2.1, 5.2.2, 5.2.3, 5.3.1, 5.3.2, 5.4.1, 5.5.1, 5.5.2, 5.5.3##
5+^.^|
*Topic 3: Table Views and Navigation Controllers* +
[outcomes]##Outcomes: 5.1.1, 5.1.2, 5.2.1, 5.2.2, 5.2.3, 5.4.1, 5.5.1##
|
...
. developing an understanding of Swift and object-oriented programming, together with the programming theory which underpins the practical components of programming

. learning about how to develop applications for the iPhone and iPad using the Cocoa Touch frameworks and the Xcode development environment

. learning about the considerations when developing applications for mobile devices such as the iPhone and iPad

. developing an understanding of the marketplace for mobile applications, in particular the iTunes App Store
...
* *Semester One:* _Apple Development with Swift_ iBook and _Learn Version Control with Git_ eBook.
* *Semester Two:* Ray Wenderlich Video Tutorial Series: https://videos.raywenderlich.com[https://videos.raywenderlich.com^]
* MacBook laptop computer.
* iOS device (such as an iPad, iPhone, or iPod Touch) capable of running iOS 10.
* iOS SDK (including Xcode 8).
* Apple Developer Program subscription.

All students are required to purchase the Semester One and Semester Two resources.

* For Semester One, the e-books are provided for free.
* For Semester Two, the Ray Wenderlich video tutorial series is a subscription-based service and each student will need to individually sign-up and pay for a 5 month subscription, starting from the beginning of Term Three (July). We have negotiated a 50% discount, so this will cost USD$47.50 for the five months (July - November inclusive). Instructions will be provided at the end of Term Two about how to sign-up for the videos with our discount.

As noted, students must also have a paid Apple Developer Program subscription which costs $149/year. This will allow students to distribute apps on the App Store. It also gives access to beta versions of iOS and Xcode along with including advanced capabilities within apps (such as CloudKit, Maps, etc.). Instructions on how to sign-up link:apple_developer_program_enrolment.pdf[can be found here^].

== Final Project

The climax of this course is the final project. The final project is your opportunity to take your newfound savvy with iOS development out for a spin and develop your very own piece of software. So long as your project draws upon the course’s lessons, the nature of your project is entirely up to you, albeit subject to your teacher's approval. All that we ask is that you build something of interest to you, that you solve an actual problem, that you impact the School, or that you change the world. Strive to create something that outlives this course.
...
Additional details on the CGS Computing Hackathon’s logistics will be announced when the project specifications are released early in Term 3.
...
** There is a *ZERO TOLERANCE* policy on homework completion. On the first instance your homework is incomplete a note will be written in your diary. On the second instance an email will be sent home. On the third (and subsequent) instances you will receive a detention and/or be directed to a Period 6 session.
