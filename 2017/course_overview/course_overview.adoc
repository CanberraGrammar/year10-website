...
Outcomes: 5.1.1, 5.2.1, 5.2.2, 5.5.1

{set:cellbgcolor:white}
^.^| *Term 2*
4+^.^|
*Topic 2: Git version control* +
Outcomes: 5.1.1, 5.1.2, 5.2.1, 5.2.2, 5.2.3, 5.3.1, 5.3.2, 5.4.1, 5.5.1, 5.5.2, 5.5.3
5+^.^|
*Topic 3: Table Views and Navigation Controllers* +
Outcomes: 5.1.1, 5.1.2, 5.2.1, 5.2.2, 5.2.3, 5.4.1, 5.5.1
|
