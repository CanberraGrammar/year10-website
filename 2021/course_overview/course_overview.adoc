...
* AWS DeepRacer League competition
...
^.^| *Term 2*
4+^.^|
*Topic 3: Binary Exploitation* (continued) +
6+^.^|
*Topic 4: PCAP (Packet Capture and Analysis)* +
...
{set:cellbgcolor:grey}
5+^.^|
*Topic 8: AWS DeepRacer League Competition* +
{set:cellbgcolor:white}
^.^| *Exam Week*
{set:cellbgcolor:grey}
2+^.^|
*Prepare for 2022 Courses* +
{set:cellbgcolor:white}
1+|
{set:cellbgcolor:grey}
